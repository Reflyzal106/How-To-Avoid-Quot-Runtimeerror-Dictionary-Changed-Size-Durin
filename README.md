# [SOLVED] How-To-Avoid-Quot-Runtimeerror-Dictionary-Changed-Size-Durin
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-to-avoid-quot-runtimeerror-dictionary-changed-size-durin)
>
...
Use d = dict((k, v) for k, v in d.items()) to create a new dictionary without modifying the original one.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-to-avoid-quot-runtimeerror-dictionary-changed-size-durin)**
